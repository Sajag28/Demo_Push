...
def func():
   data=pd.read_csv("raw_dataset/CSE_Train_dataset.csv")
   param=data.shape[1]
   ...
   data["Conference Level"]=data["Conference Level"].replace({
      '3.8':"National",
      '3.9':"International",
      '4':"National",
      '4.1':"International",
   ...
   data["Conference Num"]=data["Conference Level"].replace({
      'International':1,
      'National':2
   })
  
   data.to_csv("raw_dataset/CSE_Train_dataset.csv", index=False)
